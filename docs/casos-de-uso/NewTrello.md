### Trello (Updated Architecture)

This configuration uses the new **Secondary Authentication (App Tokens)** support. The Trello Token is now managed at the provider level, keeping the tool paths clean.
...
[
  {
    ...
    "secondaryApiKeyName": "token",
    "secondaryApiKeyValue": "<YOUR_TRELLO_TOKEN>",
    ...
    "tools": [
      {
        ...
        "endpointPath": "/1/members/me/boards",
        "httpMethod": "GET",
        "enabled": true,
        "isExportable": true,
        "parameters": []
      },
      {
        ...
        "endpointPath": "/1/boards/{board_id}/lists",
        "httpMethod": "GET",
        "enabled": true,
        "isExportable": true,
        "parameters": [
      ...
      },
      {
        ...
        "endpointPath": "/1/boards/{board_id}/cards",
        "httpMethod": "GET",
        "enabled": true,
        "isExportable": true,
        "parameters": [
      ...
      },
      {
        ...
        "endpointPath": "/1/cards/{card_id}/actions/comments",
        "httpMethod": "POST",
        "enabled": true,
        "isExportable": true,
